...
def testing_model(result, dataset):
    ...
    query_cam = np.array(result['query_cam'][0])
    query_label = np.array(result['query_label'][0])
    gallery_feature = torch.FloatTensor(result['gallery_f'])
    gallery_cam = np.array(result['gallery_cam'][0])
    gallery_label = np.array(result['gallery_label'][0])
